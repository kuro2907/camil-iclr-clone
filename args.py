...
def parse_args():
    ...
    parser.add_argument(
        "--epochs",
        dest="epochs",
        help="number of epochs to train CAMIL",
        default=30,
        type=int,
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default="label_files/camelyon_data.csv",
        type=str,
    )
    parser.add_argument(
        "--csv_file",
        dest="csv_file",
        help="csv file with information about the labels",
        default="camelyon_csv_splits/splits_0.csv",
        type=str,
    )
    parser.add_argument(
        "--raw_save_dir",
    ...
    parser.add_argument(
        "--save_exp_code", type=str, default=None, help="experiment code"
    )
    parser.add_argument("--overlap", type=float, default=None)
    parser.add_argument(
        "--config_file", type=str, default="heatmap_config_template.yaml"
    )
    parser.add_argument(
        "--subtyping", dest="subtyping", action="store_true", default=False
    )
